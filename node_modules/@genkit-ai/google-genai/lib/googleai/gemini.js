...
const GeminiConfigSchema = import_model.GenerationCommonConfigSchema.extend({
  ...
  safetySettings: (0, import_genkit.annotateSchema)(
    import_genkit.z.array(SafetySettingsSchema).describe(
    ...
    { [import_genkit.GENKIT_UI_METADATA.WIDGET]: import_genkit.GENKIT_UI_WIDGETS.SAFETY_SETTINGS }
  ),
...
function defineModel(name, pluginOptions) {
  ...
  return (0, import_plugin.model)(
    ...
    async (request, { streamingRequested, sendChunk, abortSignal }) => {
      ...
      const jsonMode = request.output?.format === "json" || request.output?.contentType === "application/json";
