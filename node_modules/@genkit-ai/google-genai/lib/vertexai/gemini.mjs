...
import {
  ...
  toGeminiTool
} from "../common/converters.mjs";
import { isKnownKey } from "../common/utils.mjs";
import { generateContent, generateContentStream } from "./client.mjs";
import { toGeminiLabels, toGeminiSafetySettings } from "./converters.mjs";
import {
...
const GeminiConfigSchema = GenerationCommonConfigSchema.extend({
  ...
  safetySettings: annotateSchema(
    z.array(SafetySettingsSchema).describe(
...
function defineModel(name, clientOptions, pluginOptions) {
  ...
  return pluginModel(
    ...
    async (request, { streamingRequested, sendChunk, abortSignal }) => {
      ...
      const jsonMode = request.output?.format === "json" || !!request.output?.schema;
      if (toolsFromConfig) {
