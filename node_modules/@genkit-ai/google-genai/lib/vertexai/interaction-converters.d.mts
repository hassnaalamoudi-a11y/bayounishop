import { MessageData, Operation, GenerateResponseData, Part } from 'genkit';
import { ToolDefinition } from 'genkit/model';
import { GeminiInteraction, Content, InteractionTool, Turn } from './interaction-types.mjs';
 ...
 */
declare function toInteractionContent(part: Part): Content;
/**
 ...
 */
declare function toInteractionTurn(message: MessageData): Turn;
/**
...
export { ensureToolIds, fromInteraction, fromInteractionContent, fromInteractionSync, toInteractionContent, toInteractionRole, toInteractionTool, toInteractionTurn };
